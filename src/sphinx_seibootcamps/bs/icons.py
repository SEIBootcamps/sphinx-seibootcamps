...
def build_substitution(icon_code) -> str:
    return f"""\
...
def build_bs_icons_substitutions() -> str:
    return "\n\n".join([build_substitution(icon_code) for icon_code in BS_ICONS])
